...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "Hotel" ADD COLUMN "timezone" TEXT NOT NULL DEFAULT 'Asia/Almaty';
...
BEGIN
    IF NOT EXISTS (
        ...
        ALTER TABLE "Hotel" ADD COLUMN "currency" TEXT NOT NULL DEFAULT 'KZT';
...
-- 10. Казахстанские дефолты для этой копии проекта
UPDATE "Hotel"
SET "country" = 'KZ'
WHERE "country" = 'KG';
